  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?=base_url('admin/dashboard')?>">
        ...
        <div class="sidebar-brand-text mx-3">Laundry <sup>in</sup></div>
      </a>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small"> <?php foreach ($query->result() as $user){ echo $user->nama; }?><br><b><center><?php $level = $this->session->userdata('level');
                if ($level==1){
                  $posisi ='Admin';
                }else{
                  $posisi = 'Karyawan';
