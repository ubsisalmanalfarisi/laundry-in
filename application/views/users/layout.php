...
<head>
  ...
  <title>Laundry-in | <?=$section?>  </title>
          ...
          <div class="col-lg-6 h-100 text-center text-lg-left my-auto text-white">
            <ul class="list-inline mb-2 ">
              <li class="list-inline-item ">
                <a href="<?=base_url('')?>" class="text-light font-weight-bold">Home</a>
              </li>
              <li class="list-inline-item">&sdot;</li>
              <li class="list-inline-item">
                <a href="<?=base_url('tarif')?>" class="text-light font-weight-bold">Daftar Tarif</a>
              </li>
              <li class="list-inline-item">&sdot;</li>
              <li class="list-inline-item">
                <a href="<?=base_url('cari')?>" class="text-light font-weight-bold">Lacak</a>
              </li>
              <li class="list-inline-item">&sdot;</li>
              <li class="list-inline-item">
                <a href="<?=base_url('kontak')?>" class="text-light font-weight-bold">Kontak</a>
              </li>
            </ul>
            <p class="text-white small mb-4 mb-lg-0">&copy; Laundry-in 2022. All Rights Reserved.</p>
          </div>
