            ...
            <form method="GET" action="<?=base_url('cari')?>">
              <div class="form-row">
                <div class="col-12 col-md-9 mb-2 mb-md-0">
                  ...
                  <p class="text-left font-italic">Input 04062215064601 or 04062215172102 untuk demo</p>
                </div>
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="testimonial-item mx-auto mb-5 mb-lg-0">
              ...
              <p class="font-weight-light mb-0">"Bersih, wangi dan rapi.... Recomended pokoknya !"</p>
            </div>
          </div>
          <div class="col-lg-4">
            <div class="testimonial-item mx-auto mb-5 mb-lg-0">
              ...
              <p class="font-weight-light mb-0">"Wangi rapi bersih, terbaik no debat  "</p>
            </div>
          </div>
          <div class="col-lg-4">
            <div class="testimonial-item mx-auto mb-5 mb-lg-0">
              ...
              <h5>Sarah W.</h5>
              <p class="font-weight-light mb-0">"Cepat, rapi, dan wangi 👍"</p>
            </div>
          </div>
        </div>
      </div>
